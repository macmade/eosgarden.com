...
header( 'Location: http://www.xs-labs.com/en/archives/articles/cocoa-delegate-chain/', true, 301 );
exit();
...
?>
			...
			<div class="frame">
				...
				<div class="frame-content">
					...
					<div class="code">
						<code class="source">[ window close ];</code>
					</div>
					<div>
					...
					<div class="code">
						...
						<code class="source"><br /></code>
						<code class="source">    <span class="code-keyword">id</span> <span class="code-ctag">delegate</span>;<br /></code>
						<code class="source">}<br /></code>
						<code class="source"><br /></code>
						...
						<code class="source">- ( <span class="code-keyword">id</span> )delegate<br /></code>
						<code class="source">{<br /></code>
						<code class="source">    <span class="code-keyword">return</span> <span class="code-ctag">delegate</span>;<br /></code>
						<code class="source">}<br /></code>
						<code class="source"><br /></code>
						<code class="source">- ( <span class="code-keyword">void</span> )setDelegate: ( <span class="code-keyword">id</span> )object<br /></code>
						<code class="source">{<br /></code>
						<code class="source">    <span class="code-ctag">delegate</span> = object;<br /></code>
						<code class="source">}<br /></code>
						<code class="source"><br /></code>
					...
					<div class="code">
						<code class="source"><span class="code-keyword">@property</span>( <span class="code-keyword">nonatomic</span>, <span class="code-keyword">assign</span>, <span class="code-keyword">readwrite</span> ) <span class="code-ctag">delegate</span>;</code>
					</div>
					<div>
					...
					<div class="code">
						...
						<code class="source">    <br /></code>
						<code class="source">    <span class="code-keyword">if</span>( [ <span class="code-ctag">delegate</span> <span class="code-predefined">respondsToSelector</span>: <span class="code-keyword">@selector</span>( windowWillClose ) ] )<br /></code>
						<code class="source">    {<br /></code>
						<code class="source">        [ <span class="code-ctag">delegate</span> windowWillClose ];<br /></code>
						<code class="source">    }<br /></code>
						<code class="source">    <br /></code>
						<code class="source">    <span class="code-comment">/* Do something... */</span><br /></code>
					...
					<div class="code">
						<code class="source">[ [ <span class="code-predefined">NSNotificationCenter</span> defaultCenter ] <span class="code-predefined">addObserver</span>: foo <span class="code-predefined">selector</span>: <span class="code-keyword">@selector</span>:( myObserverMethod: ) <span class="code-predefined">name:</span> <span class="code-predefined">NSWindowWillCloseNotification</span> <span class="code-predefined">object</span>: window ]:</code>
					</div>
					<div>
					...
					<div class="code">
						...
						<code class="source"><span class="code-keyword">@protected</span><br /></code>
						<code class="source"><br /></code>
						<code class="source">    <span class="code-ctag">DelegateChain</span> * <span class="code-ctag">delegate</span>;<br /></code>
						<code class="source">}<br /></code>
						<code class="source"><br /></code>
					...
					<div class="code">
						...
						<code class="source">{<br /></code>
						<code class="source">    <span class="code-keyword">if</span>( ( <span class="code-keyword">self</span> = [ <span class="code-keyword">super</span> init ] ) )<br /></code>
						<code class="source">    {<br /></code>
						<code class="source">        <span class="code-ctag">delegate</span> = [ [ <span class="code-ctag">DelegateChain</span> alloc ] init ];<br /></code>
						<code class="source">    }<br /></code>
						<code class="source">    <br /></code>
						...
						<code class="source">{<br /></code>
						<code class="source">    [ <span class="code-ctag">delegate</span> release ];<br /></code>
						<code class="source">    [ <span class="code-keyword">super</span> dealloc ];<br /></code>
						<code class="source">}<br /></code>
						<code class="source"><br /></code>
						<code class="source">- ( <span class="code-keyword">void</span> )addDelegate: ( <span class="code-keyword">id</span> )object<br /></code>
						<code class="source">{<br /></code>
						<code class="source">    [ <span class="code-ctag">delegate</span> <span class="code-ctag">addDelegate</span>: object ];<br /></code>
						<code class="source">}<br /></code>
						<code class="source"><br /></code>
						<code class="source">- ( <span class="code-keyword">void</span> )removeDelegate: ( <span class="code-keyword">id</span> )object<br /></code>
						<code class="source">{<br /></code>
						<code class="source">    [ <span class="code-ctag">delegate</span> <span class="code-ctag">removeDelegate</span>: object ];<br /></code>
						<code class="source">}<br /></code>
						<code class="source"><br /></code>
						<code class="source">- ( <span class="code-predefined"><span class="code-predefined">NSArray</span></span> * )delegates<br /></code>
						<code class="source">{<br /></code>
						<code class="source">    <span class="code-keyword">return</span> [ <span class="code-ctag">delegate</span> <span class="code-ctag">delegates</span> ];<br /></code>
						<code class="source">}<br /></code>
						<code class="source"><br /></code>
						<code class="source"><span class="code-keyword">@end</span></code>
					</div>
					...
					<div class="code">
						...
						<code class="source"><span class="code-keyword">@protected</span><br /></code>
						<code class="source"><br /></code>
						<code class="source">    <span class="code-keyword">id</span>                  * <span class="code-ctag">delegates</span>;<br /></code>
						<code class="source">    <span class="code-predefined">NSUInteger</span>            <span class="code-ctag">numberOfDelegates</span>;<br /></code>
						<code class="source">    <span class="code-predefined">NSUInteger</span>            <span class="code-ctag">sizeOfDelegatesArray</span>;<br /></code>
						<code class="source">    <span class="code-predefined">NSMutableDictionary</span> * <span class="code-ctag">hashs</span>;<br /></code>
						<code class="source">}<br /></code>
						<code class="source"><br /></code>
						<code class="source">- ( <span class="code-keyword">void</span> )addDelegate: ( <span class="code-keyword">id</span> )object;<br /></code>
						<code class="source">- ( <span class="code-keyword">void</span> )removeDelegate: ( <span class="code-keyword">id</span> )object;<br /></code>
					...
					<div class="code">
						...
						<code class="source">    <span class="code-keyword">if</span>( ( <span class="code-keyword">self</span> = [ <span class="code-keyword">super</span> init ] ) )<br /></code>
						<code class="source">    {<br /></code>
						<code class="source">        hash = [ [ <span class="code-predefined">NSMutableDictionary</span> <span class="code-predefined">dictionaryWithCapacity</span>: 10 ] retain ];<br /></code>
						<code class="source">        <br /></code>
						<code class="source">        <span class="code-keyword">if</span>( <span class="code-keyword">NULL</span> = ( <span class="code-ctag">delegates</span> = ( <span class="code-keyword">id</span> * )<span class="code-predefined">calloc</span>( 10, <span class="code-keyword">sizeof</span>( <span class="code-keyword">id</span> ) ) ) )<br /></code>
						<code class="source">        {<br /></code>
					...
					<div class="code">
						<code class="source">- ( <span class="code-keyword">void</span> )dealloc<br /></code>
						<code class="source">{<br /></code>
						<code class="source">    <span class="code-predefined">free</span>( <span class="code-ctag">delegates</span> );<br /></code>
						<code class="source">    [ <span class="code-ctag">hashs</span> release ];<br /></code>
						<code class="source">    [ <span class="code-keyword">super</span> dealloc ];<br /></code>
						<code class="source">}</code>
					</div>
					<div>
					...
					<div class="code">
						...
						<code class="source">    }<br /></code>
						<code class="source">    <br /></code>
						<code class="source">    <span class="code-keyword">if</span>( <span class="code-ctag">numberOfDelegates</span> == <span class="code-ctag">sizeOfDelegatesArray</span> )<br /></code>
						<code class="source">    {<br /></code>
						<code class="source">        <span class="code-keyword">if</span>( <span class="code-keyword">NULL</span> == ( <span class="code-ctag">delegates</span> = ( <span class="code-keyword">id</span> * )<span class="code-predefined">realloc</span>( <span class="code-ctag">delegates</span>, ( <span class="code-ctag">sizeOfDelegatesArray</span> + 10 ) * <span class="code-keyword">sizeof</span>( <span class="code-keyword">id</span> ) ) ) )<br /></code>
						<code class="source">        {<br /></code>
						<code class="source">            <span class="code-comment">/* Error management... */</span><br /></code>
						<code class="source">        }<br /></code>
						<code class="source">        <br /></code>
						<code class="source">        <span class="code-ctag">sizeOfDelegatesArray</span> += 10;<br /></code>
						<code class="source">    }<br /></code>
						<code class="source">    <br /></code>
						<code class="source">    hash = [ [ <span class="code-predefined">NSNumber</span> <span class="code-predefined">numberWithUnsignedInteger</span>: ( <span class="code-predefined">NSUInteger</span> )object ] stringValue ];<br /></code>
						<code class="source">    <br /></code>
						<code class="source">    <span class="code-keyword">if</span>( [ <span class="code-ctag">hashs</span> <span class="code-predefined">objectForKey</span>: hash ] != <span class="code-keyword">nil</span> )<br /></code>
						<code class="source">    {<br /></code>
						<code class="source">        <span class="code-keyword">return</span>;<br /></code>
						<code class="source">    }<br /></code>
						<code class="source">    <br /></code>
						<code class="source">    <span class="code-ctag">delegates</span>[ <span class="code-ctag">numberOfDelegates</span> ] = object;<br /></code>
						<code class="source">    <br /></code>
						<code class="source">    [ <span class="code-ctag">hashs</span> <span class="code-predefined">setObject</span>: [ <span class="code-predefined">NSNumber</span> <span class="code-predefined">numberWithUnsignedInteger</span>: <span class="code-ctag">numberOfDelegates</span> ] <span class="code-predefined">forKey</span>: hash ];<br /></code>
						<code class="source">    <br /></code>
						<code class="source">    <span class="code-ctag">numberOfDelegates</span>++;<br /></code>
						<code class="source">}</code>
					</div>
					<div>
					...
					<div class="code">
						...
						<code class="source">    <br /></code>
						<code class="source">    <span class="code-keyword">if</span>( object == <span class="code-keyword">nil</span> || <span class="code-ctag">numberOfDelegates</span> == 0 )<br /></code>
						<code class="source">    {<br /></code>
						<code class="source">        <span class="code-keyword">return</span>;<br /></code>
						<code class="source">    }<br /></code>
						<code class="source">    <br /></code>
						...
						<code class="source">    }<br /></code>
						<code class="source">    <br /></code>
						<code class="source">    index = [ [ <span class="ctag">hashs</span> <span class="code-predefined">objectForKey</span>: hash ] unsignedIntegerValue ];<br /></code>
						<code class="source">    <br /></code>
						<code class="source">    <span class="code-keyword">for</span>( i = index; i < <span class="code-ctag">numberOfDelegates</span> - 1; i++ )<br /></code>
						<code class="source">    {<br /></code>
						<code class="source">        <span class="code-ctag">delegates</span>[ i ] = <span class="code-ctag">delegates</span>[ i + 1 ];<br /></code>
						<code class="source">    }<br /></code>
						<code class="source">    <br /></code>
						<code class="source">    [ hash <span class="code-predefined">removeObjectForKey</span>: hash ];<br /></code>
						<code class="source">    <br /></code>
						<code class="source">    <span class="code-ctag">numberOfDelegates</span>--;<br /></code>
						<code class="source">}</code>
					</div>
					...
					<div class="code">
						...
						<code class="source">    <br /></code>
						<code class="source">    <span class="code-keyword">if</span>( <span class="code-ctag">numberOfDelegates</span> == 0 )<br /></code>
						<code class="source">    {<br /></code>
						<code class="source">        <span class="code-keyword">return</span> [ <span class="code-predefined">NSArray</span> array ];<br /></code>
						<code class="source">    }<br /></code>
						<code class="source">    <br /></code>
						<code class="source">    delegatesArray = [ <span class="code-predefined">NSMutableArray</span> <span class="code-predefined">arrayWithCapacity</span>: <span class="code-ctag">numberOfDelegates</span> ];<br /></code>
						<code class="source">    <br /></code>
						<code class="source">    <span class="code-keyword">for</span>( i = 0; i < <span class="code-ctag">numberOfDelegates</span>; i++ )<br /></code>
						<code class="source">    {<br /></code>
						<code class="source">        [ delegatesArray <span class="code-predefined">addObject</span>: <span class="code-ctag">delegates</span>[ i ] ];<br /></code>
						<code class="source">    }<br /></code>
						<code class="source">    <br /></code>
					...
					<div class="code">
						<code class="source"><span class="code-keyword">if</span>( [ <span class="code-ctag">delegate</span> <span class="code-predefined">respondsToSelector</span>: <span class="code-keyword">@selector</span>( someMethod ) ] )<br /></code>
						<code class="source">{}</code>
					</div>
					<div>
					...
					<div class="code">
						...
						<code class="source">    <span class="code-keyword">for</span>( i = 0; i < <span class="code-ctag">numberOfDelegates</span>; i++ )<br /></code>
						<code class="source">    {<br /></code>
						<code class="source">        <span class="code-keyword">if</span>( [ <span class="code-ctag">delegates</span>[ i ] <span class="code-predefined">respondsToSelector</span>: selector ] == <span class="code-keyword">YES</span> )<br /></code>
						<code class="source">        {<br /></code>
					...
					<div class="code">
						...
						<code class="source">        <span class="code-keyword">if</span>( [ <span class="code-ctag">delegates</span>[ i ] <span class="code-predefined">respondsToSelector</span>: selector ] == <span class="code-keyword">YES</span> )<br /></code>
						<code class="source">        {<br /></code>
						<code class="source">            <span class="code-keyword">return</span> [ [ <span class="code-ctag">delegates</span>[ i ] class ] <span class="code-predefined">instanceMethodSignatureForSelector</span>: selector ];<br /></code>
						<code class="source">        }<br /></code>
						<code class="source">    }<br /></code>
						<code class="source">    <br /></code>
					...
					<div class="code">
						<code class="source">- ( <span class="code-keyword">void</span> )forwardInvocation: ( NSInvocation * )invocation<br /></code>
						<code class="source">{<br /></code>
						<code class="source">    <span class="code-predefined">NSUInteger</span> i;<br /></code>
						<code class="source">    <br /></code>
						<code class="source">    <span class="code-keyword">for</span>( i = 0; i < <span class="code-ctag">numberOfDelegates</span>; i++ )<br /></code>
						<code class="source">    {<br /></code>
						<code class="source">        <span class="code-keyword">if</span>( [ <span class="code-ctag">delegates</span>[ i ] <span class="code-predefined">respondsToSelector</span>: [ invocation selector ] ] == <span class="code-keyword">YES</span> )<br /></code>
						<code class="source">        {<br /></code>
						<code class="source">            [ invocation <span class="code-predefined">invokeWithTarget</span>: <span class="code-ctag">delegates</span>[ i ] ];<br /></code>
						<code class="source">        }<br /></code>
						<code class="source">    }<br /></code>
						<code class="source">}</code>
					</div>
